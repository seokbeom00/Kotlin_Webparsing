...
import com.example.assignment3_webtoon.databinding.FragmentFridayBinding
import com.example.assignment3_webtoon.databinding.FragmentSaturdayBinding
...
class SaturdayFragment : Fragment(){
    ...
    val url = "https://www.toomics.com/webtoon/weekly/dow/6"
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        recyclerView = binding.recycle6
        getWebtoonMain()

        adapter = DayAdapter(data)
        recyclerView.adapter = adapter
        binding.recycle6.apply {
