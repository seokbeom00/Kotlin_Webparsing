...
import com.example.assignment3_webtoon.databinding.FragmentSundayBinding
...
class SundayFragment : Fragment(){
    ...
    val url = "https://www.toomics.com/webtoon/weekly/dow/7"
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        recyclerView = binding.recycle7
        getWebtoonMain()

        adapter = DayAdapter(data)
        recyclerView.adapter = adapter
        binding.recycle7.apply {
